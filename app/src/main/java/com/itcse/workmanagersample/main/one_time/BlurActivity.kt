...
/**
 * Activity containing one time use work manager which allows blurring of an image using WorkManger in the background.
 *
 * credits - https://github.com/googlecodelabs/android-workmanager
 */
